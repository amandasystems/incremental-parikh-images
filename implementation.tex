...
variables of one of the automata is known to be either \Fudge{present or absent}. The
number was chosen experimentally. The other automaton for the product is
selected randomly.

% this is unclear; don't we delay computing products until one of the
% automata is (almost) completely defined?
