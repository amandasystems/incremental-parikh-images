...
0\right]$. Initially, we let $\Filter$ map to fresh variables to obtain, after some simplifications:
...
%
  \multicolumn{6}{c}{
    \FlowEq(\mathcal{A}', \Filter)  = \begin{aligned}
                       1 + \cancel{\TransitionVar_5} &= \cancel{\TransitionVar_5} + \TransitionVar_4 + \TransitionVar_3\\
