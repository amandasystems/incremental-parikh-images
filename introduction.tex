Extending automated theorem provers and SMT solvers with support for
rich string constraints is important for program analysis, in
particular to detect cross-site scripting vulnerabilities and other
string manipulation bugs~\cite{DBLP:books/sp/BultanYAA17}.
%
...
i.e., Presburger-definable~\cite{parikh-theorem}. As mentioned,
Parikh images are 
...
% AS please verify that this is not a lie!

% PR from looking quickly at this article, it seems to solve a
